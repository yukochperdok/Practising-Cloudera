...
public class DriverWordCountStopWord extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    // Nuestra clase
    job.setJarByClass(DriverWordCountStopWord.class);
    // Nuestro Mapper
    job.setMapperClass(MapperWordCountStopWord.class);
    // Nuestro Reducer
  ...
  public static void main(String[] args) throws Exception {
    ...
    ToolRunner.run(conf, new DriverWordCountStopWord(), args);

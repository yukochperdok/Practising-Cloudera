...
public class DriverWordCountPubli extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    // Nuestra clase
    job.setJarByClass(DriverWordCountPubli.class);
    // Nuestro Mapper
    job.setMapperClass(MapperWordCountPubli.class);
    // Nuestro Reducer
    job.setReducerClass(ReducerWordCountPubli.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    ToolRunner.run(conf, new DriverWordCountPubli(), args);

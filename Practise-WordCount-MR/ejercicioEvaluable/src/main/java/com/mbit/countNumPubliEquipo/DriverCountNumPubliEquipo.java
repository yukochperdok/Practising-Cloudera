...
public class DriverCountNumPubliEquipo extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    // Nuestra clase
    job.setJarByClass(DriverCountNumPubliEquipo.class);
    // Nuestro Mapper
    job.setMapperClass(MapperCountNumPubliEquipo.class);
    // Nuestro Reducer
    job.setReducerClass(ReducerCountNumPubliEquipo.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    ToolRunner.run(conf, new DriverCountNumPubliEquipo(), args);

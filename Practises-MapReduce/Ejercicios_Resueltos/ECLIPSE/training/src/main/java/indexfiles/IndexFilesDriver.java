...
public class IndexFilesDriver {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length != 2) {
      System.out.printf(
"Usage: IndexFilesDriver <input dir> <output dir>\n");
      System.exit(-1);
    }
     ...
     */
    job.setJarByClass(IndexFilesDriver.class);
    
    /*
     * Specify an easily-decipherable name for the job.
     * This job name will appear in reports and logs.
     */
    job.setJobName("Index Files");
    ...
    job.setReducerClass(SumFilesReducer.class);

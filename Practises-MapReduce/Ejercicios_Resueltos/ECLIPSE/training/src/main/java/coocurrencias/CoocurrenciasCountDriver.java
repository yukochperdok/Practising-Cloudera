 ...
 */
public class CoocurrenciasCountDriver {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length != 2) {
      System.out.printf(
"Usage: CoocurrenciasCountDriver <input dir> <output dir>\n");
      System.exit(-1);
    }
     ...
     */
    job.setJarByClass(CoocurrenciasCountDriver.class);
    
    /*
     * Specify an easily-decipherable name for the job.
     * This job name will appear in reports and logs.
     */
    job.setJobName("CoocurrenciasCountDriver");
     ...
     */
    job.setMapperClass(CountCoocurMapper.class);
    job.setReducerClass(SumCoocurReducer.class);
